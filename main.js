...
import BookRepairPage from "./pages/BookRepairPage.vue";
import BookedRepairsPage from "./pages/BookedRepairsPage.vue";
import RepairManagement from "./pages/RepairManagement.vue";
